	...
	// guardar producto
		public boolean guardar(Producto producto) throws SQLException {
			...
			try {
				...
				sql = "INSERT INTO producto (id, nombre, cantidad, precio, fecha_creacion, fecha_actualiza) VALUES(?,?,?,?,?,?)";
		...
		public boolean editar(Producto producto) throws SQLException {
			...
			try {
				connection.setAutoCommit(false);
				sql = "UPDATE producto SET nombre=?, cantidad=?, precio=?, fecha_actualiza=? WHERE id=?";
